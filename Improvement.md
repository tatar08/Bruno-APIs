...
### P1.1 Server File Explorer and Transfer Center 🟡 เสร็จบางส่วน (folder-picking modal + upload/download + progress/cancel + create-folder/rename + file-picker multi-select/preview + search/recent/favorites จริงแล้ว; checksum-resume/opaque-handle/machine-label ยังไม่ทำ)
