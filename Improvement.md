...
### P1.1 Server File Explorer and Transfer Center 🟡 เสร็จบางส่วน (folder-picking modal + upload/download จริงแล้ว; search/favorites/create-folder/preview/progress/opaque-handle ยังไม่ทำ)
