...
### P1.1 Server File Explorer and Transfer Center 🟡 เสร็จบางส่วน (folder-picking modal + upload/download + progress/cancel + create-folder/rename จริงแล้ว; search/favorites/preview/checksum-resume/opaque-handle ยังไม่ทำ)
