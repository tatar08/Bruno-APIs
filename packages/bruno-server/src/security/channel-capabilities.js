 ...
 * mechanically in HandlerRegistry via a call-stack walk (see
 * handler-registry.js#_captureSourceFile), not hand-guessed from channel
 * name prefixes. A hand-guessed list drifts silently as handlers move
 * between files; this one is verified against the live registry by
 * channel-capabilities.spec.js, which fails if any registered channel maps
 * to 'unknown'.
 *
